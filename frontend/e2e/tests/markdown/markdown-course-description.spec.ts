...
test.describe('Course Description Markdown Rendering', () => {
  test('instructor can create a course with markdown description', async ({ page }) => {
    ...
    await MarkdownTestUtils.verifyMarkdownRendering(page, '.markdown-editor-preview', {
      headers: true,
      paragraphs: true,
      lists: true,
      codeBlocks: true,
    ...
    await MarkdownTestUtils.verifyMarkdownRendering(page, '.course-description-container', {
      headers: true,
      paragraphs: true,
      lists: true,
      codeBlocks: true,
  ...
  test('student can view course with markdown description', async ({ page }) => {
    ...
    await MarkdownTestUtils.verifyMarkdownRendering(page, '.course-description', {
      headers: true,
      paragraphs: true,
      lists: true,
      codeBlocks: true,
