...
class MultipleChoiceQuizTaskTypeTestCase(TestCase):
    ...
    def test_multiple_choice_quiz_task_type_creation(self):
        ...
        self.assertEqual(quiz_config.points_per_question, 3.00)
    ...
    def test_quiz_submission_validation(self):
        ...
        self.assertAlmostEqual(score, 9.00)  # 3 questions * 3.00 points
        ...
        self.assertAlmostEqual(score, 3.00)  # Only first question correct
        self.assertEqual(len(detailed_results), 3)
    ...
    def test_quiz_submission_model(self):
        ...
        self.assertAlmostEqual(submission.score, 9.00)
        self.assertAlmostEqual(submission.max_score, 9.00)
