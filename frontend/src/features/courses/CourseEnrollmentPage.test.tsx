...
import { fetchCourses, fetchUserCourseProgress, fetchUserEnrollments } from '@services/courseService';
...
describe('CourseEnrollmentPage', () => {
    ...
    it('should display "Enroll" button for unenrolled courses', async () => {
        (fetchCourses as jest.Mock).mockResolvedValue({
            results: [{ id: '3', title: 'Course 3', description: 'Description 3', enrollmentStatus: 'open' }],
        });
