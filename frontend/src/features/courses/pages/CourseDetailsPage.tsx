...
import { fetchCourseDetails, fetch } from '../../../services/resources/courseService';
...
const CourseDetailsPage: React.FC = () => {
  ...
  const {
    ...
    error: courseError,
  } = useQuery(['courseDetails', courseId], () => fetchCourseDetails(Number(courseId)), {
    enabled: !!courseId,
  });
  ...
  const {
    ...
    error: tasksError,
  } = useQuery(['learningTasks', courseId], () => CourseService.getTasks(courseId!), {
    enabled: !!courseId,
  });
