...
test.describe('Frontend Views', () => {
  test('Dashboard view renders correctly', async ({page}) => {
    ...
    const dashboardTitle = await page.locator('h1:has-text("Dashboard"), h2:has-text("Dashboard"), h3:has-text("Dashboard"), h4:has-text("Dashboard"), h4:has-text("Instructor Dashboard"), [data-testid="dashboard-title"]').first();
  ...
  test('Profile view renders correctly', async ({page}) => {
    ...
    const profileTitle = await page.locator('h1:has-text("Profile"), h2:has-text("Profile"), h3:has-text("Profile"), h4:has-text("User Profile"), h4:has-text("Profile"), [data-testid="profile-title"]').first();
