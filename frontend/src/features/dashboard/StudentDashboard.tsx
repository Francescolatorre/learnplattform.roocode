...
import { Box, Typography, List, ListItem, ListItemText, LinearProgress, Card, CardContent, Divider } from '@mui/material';
    ...
    useEffect(() => {
        const loadDashboardData = async () => {
            try {
                ...
                const taskData = await fetchLearningTasks();
                ...
                <CardContent>
                    ...
                    <List>
                        {enrollments.map((enrollment) => (
                            <ListItem key={enrollment.course.id} component={Link} to={`/courses/${enrollment.course.id}/details`} button>
                                <ListItemText
            ...
            <Card>
                <CardContent>
                    ...
                    <Typography variant="body1">
                        Completed Tasks: {enrollments.reduce((sum, e) => sum + (e.progress_percentage === 100 ? 1 : 0), 0)}
                    </Typography>
                    <Typography variant="body1">
