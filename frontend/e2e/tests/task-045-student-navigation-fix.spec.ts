...
test.describe('TASK-045: Student Task Navigation Fix', () => {
  test('student can successfully navigate from course to individual task details', async ({ page }) => {
    ...
    const courseElements = await page.locator('[data-testid^="course-"], .course-card, .course-item');
    ...
    const viewTaskButtons = page.locator('button:has-text("View Task"), [data-testid*="view-task"]');
