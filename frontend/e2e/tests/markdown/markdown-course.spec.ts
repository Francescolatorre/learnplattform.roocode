...
import { CourseCreationPage, InstructorCoursesPage, StudentCoursesPage } from '../../page-objects';
...
test.describe('Course Description Markdown Rendering', () => {
  ...
  test('instructor can create a course with markdown description', async ({ page }) => {
    ...
    try {
      await courseCreationPage
        .fillCategory('General')
    ...
    const successVisible = await page
      .getByText(/Course created successfully|Course saved|saved successfully/)
      .isVisible()
      .catch(() => false);
    ...
    console.log(
      `Success message visible: ${successVisible}, Course detail page: ${isCourseDetailPage}`
    );
