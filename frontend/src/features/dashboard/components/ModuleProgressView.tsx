    ...
    return (
        <Box>
            ...
            <Typography variant="body1" paragraph>
                Track your progress through each module of the course. Expand a module to see detailed information about its sections and tasks.
            </Typography>
                    ...
                    return (
                        ...
                        >
                            ...
                            <AccordionDetails>
                                    ...
                                    <Grid container spacing={3}>
                                        ...
                                        <Grid item xs={12} sm={4}>
                                            <Paper sx={{ p: 2, textAlign: 'center', height: '100%' }}>
                                                ...
                                                />
                                                <Typography variant="h6">
                                                    {moduleStructure?.duration || 0} min
                                                </Typography>
                                                <Typography variant="body2" color="textSecondary">
                                                    Estimated Duration
                                                </Typography>
                                        ...
                                        <Grid item xs={12} sm={4}>
                                            <Paper sx={{ p: 2, textAlign: 'center', height: '100%' }}>
                                                ...
                                                />
                                                <Typography variant="h6">
                                                    {module.averageScore !== null ? `${module.averageScore.toFixed(1)}%` : 'N/A'}
                                                </Typography>
                                                <Typography variant="body2" color="textSecondary">
                                                    Average Score
                                                </Typography>
                                ...
                                {moduleStructure && moduleStructure.sections.map(section => (
