        ...
        <Card sx={{p: 3, m: 2}}>
            ...
            <Box sx={{mb: 3}}>
                <FormControl sx={{minWidth: 200, mr: 2, mb: 2}}>
                    <InputLabel id="vertical-position-label" htmlFor="vertical-position-select">Vertical Position</InputLabel>
                    <Select
                        id="vertical-position-select"
                        labelId="vertical-position-label"
                        value={position.vertical}
                        label="Vertical Position"
                        onChange={(e) => setPosition({...position, vertical: e.target.value as 'top' | 'bottom'})}
                    >
                ...
                <FormControl sx={{minWidth: 200, mr: 2, mb: 2}}>
                    <InputLabel id="horizontal-position-label" htmlFor="horizontal-position-select">Horizontal Position</InputLabel>
                    <Select
                        id="horizontal-position-select"
                        labelId="horizontal-position-label"
                        value={position.horizontal}
                        label="Horizontal Position"
                        onChange={(e) => setPosition({...position, horizontal: e.target.value as 'left' | 'right'})}
                    >
            ...
            <Box sx={{mb: 3}}>
                ...
                <Button variant="contained" color="error" onClick={() => addBasicNotification('error')} sx={{mr: 1, mb: 1}}>
                    Add Error
                </Button>
                <Button variant="contained" color="warning" onClick={() => addBasicNotification('warning')} sx={{mr: 1, mb: 1}}>
                    Add Warning
                </Button>
                <Button variant="contained" color="info" onClick={() => addBasicNotification('info')} sx={{mr: 1, mb: 1}}>
                    Add Info
                </Button>
                <Button variant="contained" color="success" onClick={() => addBasicNotification('success')} sx={{mr: 1, mb: 1}}>
                    Add Success
                </Button>
            </Box>
