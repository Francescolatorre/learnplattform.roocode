...
import { ActivityEntry } from '../../../types/progressTypes';
...
const ActivityHistoryView: React.FC<ActivityHistoryViewProps> = ({
    ...
    // Format activity secondary text
    const getActivitySecondaryText = (activity: ActivityEntry) => {
        switch (activity.activityType) {
            case 'achievement_earned':
                return activity.achievementDescription || '';
            default:
                return format(parseISO(activity.timestamp), 'h:mm a');
        }
    };
                                            ...
                                            <ListItemText
                                                ...
                                                secondary={
                                                    <>
                                                        ...
                                                        {activity.activityType === 'grade_received' && activity.score !== undefined && (
                                                            <Chip
