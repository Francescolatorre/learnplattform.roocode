...
const MarkdownRenderer = forwardRef<HTMLElement, IMarkdownRendererProps>(
  ({ content, className, sx = {}, isPreview = false, component = 'div' }, ref) => {
    if (!content) {
      return null;
    }
    ...
    const mdComponents: Components = isPreview
      ? {
          ...
          p: ({ children, ...props }: MarkdownComponentProps) => (
            <div className="markdown-p" data-testid="md-preview-p" {...props}>
              {children}
            </div>
          ),
          ...
          ul: ({ children, ...props }: MarkdownComponentProps) => (
            <div className="markdown-ul" data-testid="md-preview-ul" {...props}>
              {children}
            </div>
          ),
          ol: ({ children, ...props }: MarkdownComponentProps) => (
            <div className="markdown-ol" data-testid="md-preview-ol" {...props}>
              {children}
            </div>
          ),
          li: ({ children, ...props }: MarkdownComponentProps) => (
            <div
              ...
              data-testid="md-preview-li"
              style={{ display: 'block', margin: '0.2em 0' }}
              {...props}
            >
              {children}
            </div>
          ...
          blockquote: ({ children, ...props }: MarkdownComponentProps) => (
            <div
              ...
              data-testid="md-preview-blockquote"
              style={{
                borderLeft: '4px solid #dfe2e5',
                paddingLeft: '1em',
                margin: '1em 0',
          ...
          code: ({ inline, children, ...props }: MarkdownComponentProps) =>
            inline ? (
              <code
                ...
                data-testid="md-preview-inline-code"
                {...props}
              >
                {children}
              </code>
              ...
              <div
                className="markdown-block-code"
                data-testid="md-preview-block-code"
                style={{
                  display: 'block',
                  background: '#f6f8fa',
                  padding: '0.5em',
      ...
      : {
          ...
          p: ({ children, ...props }: MarkdownComponentProps) => (
            <p className="markdown-p" data-testid="md-p" {...props}>
              {children}
            </p>
          ),
          h1: ({ children, ...props }: MarkdownComponentProps) => (
            <h1 className="markdown-h1" data-testid="md-h1" {...props}>
              {children}
            </h1>
          ),
          h2: ({ children, ...props }: MarkdownComponentProps) => (
            <h2 className="markdown-h2" data-testid="md-h2" {...props}>
              {children}
            </h2>
          ),
          h3: ({ children, ...props }: MarkdownComponentProps) => (
            <h3 className="markdown-h3" data-testid="md-h3" {...props}>
              {children}
            </h3>
          ),
          a: ({ children, href, ...props }: MarkdownComponentProps) => (
          ...
          ul: ({ children, ...props }: MarkdownComponentProps) => (
            <ul className="markdown-ul" data-testid="md-ul" {...props}>
              {children}
            </ul>
          ),
          ol: ({ children, ...props }: MarkdownComponentProps) => (
            <ol className="markdown-ol" data-testid="md-ol" {...props}>
              {children}
            </ol>
          ),
          li: ({ children, ...props }: MarkdownComponentProps) => (
            <li className="markdown-li" data-testid="md-li" {...props}>
              {children}
            </li>
          ),
          pre: ({ children, ...props }: MarkdownComponentProps) => (
            <pre className="markdown-pre" data-testid="md-pre" {...props}>
              {children}
            </pre>
          ),
          code: ({ inline, children, ...props }: MarkdownComponentProps) =>
            inline ? (
              <code className="markdown-inline-code" data-testid="md-inline-code" {...props}>
                {children}
              </code>
            ) : (
          ...
          blockquote: ({ children, ...props }: MarkdownComponentProps) => (
            <blockquote className="markdown-blockquote" data-testid="md-blockquote" {...props}>
              {children}
            </blockquote>
          ),
          em: ({ children, ...props }: MarkdownComponentProps) => (
            <em className="markdown-em" data-testid="md-em" {...props}>
              {children}
            </em>
          ),
          strong: ({ children, ...props }: MarkdownComponentProps) => (
            <strong className="markdown-strong" data-testid="md-strong" {...props}>
              {children}
            </strong>
          ),
        };
