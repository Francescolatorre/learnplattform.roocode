...
import { CourseProgress, ModuleProgress, TaskProgress, QuizHistory } from '../../../types/progressTypes';
                    ...
                    <Grid container spacing={3} alignItems="center">
                        ...
                        <Grid item xs>
                            <Typography variant="h5">
                                Student: {studentProgress.studentId}
                            </Typography>
                            <Box sx={{ display: 'flex', alignItems: 'center', mt: 1 }}>
                                ...
                                <Chip
                                    ...
                                    color={
                                        studentProgress.averageScore >= 70 ? 'success' :
                                        studentProgress.averageScore >= 50 ? 'warning' : 'error'
                                    }
                                    size="small"
                                />
                            </Box>
                        ...
                        <Grid item xs={12} md={6} key={module.moduleId}>
                            ...
                            >
                                <CardContent>
                                    ...
                                    <LinearProgress
                                        variant="determinate"
                                        value={calculateModuleCompletion(module)}
                                    />
                                </CardContent>
                            </Card>
                        </Grid>
                        ...
                        <TableBody>
                            {studentProgress.taskProgress.map(task => (
                                <TableRow key={task.taskId}>
                                    ...
                                    <TableCell>
                                        {studentProgress.moduleProgress.find(m => m.moduleId === task.moduleId)?.moduleTitle}
                                    </TableCell>
                        ...
                        <TableBody>
                            {studentProgress.recentActivity.map(activity => (
                                <TableRow key={activity.id}>
                                    ...
                                    <TableCell>
                                        {studentProgress.moduleProgress.find(m => m.moduleId === activity.moduleId)?.moduleTitle}
                                    </TableCell>
