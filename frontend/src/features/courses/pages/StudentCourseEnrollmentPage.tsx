...
const StudentStudentCourseEnrollmentPage: React.FC = () => {
...
const StudentCourseEnrollmentPageWithQueryClient: React.FC = () => {
  const queryClient = new QueryClient();
  return (
    <QueryClientProvider client={queryClient}>
      <StudentStudentCourseEnrollmentPage />
    </QueryClientProvider>
  );
};

export default StudentCourseEnrollmentPageWithQueryClient;
